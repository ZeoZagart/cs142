...
(function() {
   ...
   var comment4 = {
      ...
      "there it is. Life finds a way. MAKING IT A LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LOT LONGER", user: im, photo_id: photo2._id
   };
   ...
   var commentOnPhotoModel = function(photoId) {
   ...
   var cs142models =  {
      ...
      commentOnPhotoModel: commentOnPhotoModel,
   };
