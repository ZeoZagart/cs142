...
var portno = 3006;   // Port number to use
...
app.get('/commentsOnPhotos/:id', function(request, response) {
  console.log("~~~~~~~~~~~~~ REQUEST ARRIVED ~~~~~~~~~~~~~~~~~")
  var id = request.params.id;
  var comments = cs142models.commentOnPhotoModel(id)
  console.log("comments on photo : " + id)
  console.log(comments)
  if (comments.length === 0) {
    console.log('Comments for photo with _id:' + id + ' not found.')
    response.status(400).send('Not found')
    return
  }
